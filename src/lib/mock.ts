...
export const mockDatasets: DatasetInfo[] = [
  {
    id: "ds_x_posts", name: "X (Twitter) Posts", status: "active",
    domains: ["x.com", "twitter.com"], entries: 120345, miners: 45, fields: 9, refresh: "never",
    creator: "0xABC...1234", createdAt: "2026-03-07",
    schema: { post_id: { type: "string", required: true }, author_handle: { type: "string", required: true }, content: { type: "string", required: true }, timestamp: { type: "datetime", required: true }, likes: { type: "integer", required: false }, retweets: { type: "integer", required: false }, replies: { type: "integer", required: false }, media_urls: { type: "string[]", required: false }, language: { type: "string", required: true } },
  },
  {
    id: "ds_amazon", name: "Amazon Products", status: "active",
    domains: ["amazon.com"], entries: 82100, miners: 32, fields: 9, refresh: "7d",
    creator: "0xDEF...5678", createdAt: "2026-03-10",
  ...
  {
    id: "ds_wiki", name: "Wikipedia Articles", status: "active",
    domains: ["wikipedia.org"], entries: 96800, miners: 38, fields: 6, refresh: "never",
    creator: "0x123...ABCD", createdAt: "2026-03-08",
    schema: { title: { type: "string", required: true }, summary: { type: "string", required: true }, content: { type: "string", required: true }, categories: { type: "string[]", required: true }, last_edited: { type: "datetime", required: false }, references: { type: "integer", required: false } },
  },
  {
    id: "ds_arxiv", name: "arXiv Papers", status: "active",
    domains: ["arxiv.org"], entries: 54200, miners: 28, fields: 8, refresh: "never",
    creator: "0x456...EFGH", createdAt: "2026-03-12",
  ...
  {
    id: "ds_linkedin", name: "LinkedIn Profiles", status: "active",
    domains: ["linkedin.com"], entries: 31400, miners: 18, fields: 11, refresh: "30d",
    creator: "0x789...IJKL", createdAt: "2026-03-15",
    schema: { profile_id: { type: "string", required: true }, name: { type: "string", required: true }, headline: { type: "string", required: true }, location: { type: "string", required: false }, company: { type: "string", required: false }, industry: { type: "string", required: false }, connections: { type: "integer", required: false }, experience: { type: "string[]", required: true }, education: { type: "string[]", required: false }, skills: { type: "string[]", required: false }, profile_url: { type: "string", required: true } },
  },
  {
    id: "ds_news", name: "News Articles", status: "active",
    domains: ["reuters.com", "apnews.com"], entries: 28700, miners: 22, fields: 7, refresh: "1d",
    creator: "0xMNO...PQRS", createdAt: "2026-03-18",
    schema: { article_id: { type: "string", required: true }, title: { type: "string", required: true }, content: { type: "string", required: true }, author: { type: "string", required: false }, published: { type: "datetime", required: true }, source: { type: "string", required: true }, categories: { type: "string[]", required: false } },
  },
];
